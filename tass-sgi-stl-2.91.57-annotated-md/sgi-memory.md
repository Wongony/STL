...
#include <stl_algobase.h>  // 基本演算法如copy()
#include <stl_alloc.h>     // 負責配置與釋放
#include <stl_construct.h> // 負責建構與解構
#include <stl_raw_storage_iter.h>
#include <stl_tempbuf.h>
#include <stl_uninitialized.h> // 基本的記憶體處理函式
...
#if 0
#if defined(_MUTABLE_IS_KEYWORD) && defined(_EXPLICIT_IS_KEYWORD) && defined(__STL_MEMBER_TEMPLATES)
...
public:
  ...
  X* release const __STL_NOTHROW {
    owns = false;
    return ptr
  }
  // 為什麼上述 release 不是 release()，竟然能夠通過編譯？
  // 不，應該無法編譯。整個 auto_ptr 已被 commented out 了，見最前說明。
};
